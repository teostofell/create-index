...
describe("readDirectory()", () => {
  context("target directory contains child directories", () => {
    it("gets names of the children directories", () => {
      const names = readDirectory(
        path.resolve(fixturesPath, "children-directories")
      );
  ...
  context(
    "target directory contains child directories that do not contain index",
    () => {
      it("gets names of the children directories", () => {
        const names = readDirectory(
          path.resolve(fixturesPath, "children-directories-without-index")
        );
  ...
  context(
    "target directory contains child directories (short safe name)",
    () => {
      it("gets names of the children directories", () => {
        const names = readDirectory(
          path.resolve(fixturesPath, "children-directories-short-name")
        );
  ...
  context("target directory contains child directories (unsafe name)", () => {
    it("gets names of the children directories", () => {
      const names = readDirectory(
        path.resolve(fixturesPath, "children-directories-unsafe-name")
      );
  ...
  context("target directory contains ./index.js", () => {
    ...
    it("excludes directories if ignoreDirectories = true", () => {
      const names = readDirectory(
        path.resolve(fixturesPath, "children-index"),
  ...
  context("target directory contains dot files", () => {
    it("ignores files", () => {
      const names = readDirectory(
        path.resolve(fixturesPath, "children-dot-files")
      );
  ...
  context(
    "target directory contains non js files, and not configured to allow that",
    () => {
      it("prefers file", () => {
        const names = readDirectory(
  ...
  context(
    "target directory contains non js files, and allowing only jsx",
    () => {
      it("prefers file", () => {
  ...
  context(
    "target directory contains non js files, and allowing both js and jsx",
    () => {
      it("prefers file", () => {
    ...
    () => {
      it("prefers file", () => {
        ...
        const names = readDirectory(
          path.resolve(
            fixturesPath,
            "children-files-alt-extension-with-homonyms"
          ),
          options
        );
  ...
  context("target directory contains files with no extension", () => {
    it("ignores files", () => {
      const names = readDirectory(
        path.resolve(fixturesPath, "children-files-no-extension")
      );
  ...
  context(
    "target directory contains directories and files with the same name",
    () => {
      it("prefers file", () => {
        const names = readDirectory(
          path.resolve(fixturesPath, "children-directories-and-files")
        );
